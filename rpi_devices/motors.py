...
"""This module provides classes for various motors to be used along with a Raspberry Pi.
Each class comes with a few common methods to control the motor.
"""

__all__ = ['DCMotor', 'SimpleMotor', 'Servo']
